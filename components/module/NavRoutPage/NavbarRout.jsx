...
const NavbarRout = () => {
  return (
    <div className="NavbarRout  bg-[#fff0] mb-10  shadow-2xl w-[400px] mx-5 flex flex-col items-center rounded-[10px] max-[768px]:w-[290px] ">
        ...
        <div className="link_navbar w-full flex flex-col mt-5 ">
            ...
            <ul className="flex justify-between items-center bg-[#1a1a1acc] text-[#fff] rounded-[8px] m-2 pt-1 pb-1 px-3">
                ...
                <Link href='/AboutMe'><SiAboutdotme/></Link>
            </ul>
            <ul className="flex justify-between items-center bg-[#1a1a1acc] text-[#fff] rounded-[8px] m-2 pt-1 pb-1 px-3">
                <Link href='/Work'>نمونه کارها</Link>
                <Link href='/Work'><MdWorkOutline/></Link>
            </ul>
            <ul className="flex justify-between items-center bg-[#1a1a1acc] text-[#fff] rounded-[8px] m-2 pt-1 pb-1 px-3">
                <Link href='/Contact'>ارتباط با من</Link>
                <Link href='/Contact'><FaRegUser/></Link>
            </ul>
        </div>
    </div>
  )
